...
Binary-search the capacity between the heaviest package and the total weight. For each candidate, greedily load packages in order and count the required days.
